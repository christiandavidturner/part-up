    ...
    return function t(e, r, i) {
        ...
        4: [function(e, t, r) {
            ! function(e, t, r, i, n, o, a, s, u, l, d) {
                ...
                function m(e, t, n, o) {
                    if (o.apiEndpoint === r["default"].filesV2 || o.apiEndpoint === r["default"].graph_odb) return new d.Promise(function(e, t) {
                    ...
                    return new d.Promise(function(t, r) {
                        e.start(function(e, n) {
                            if (200 === n || 201 === n) {
                                ...
                                t(u)
                            } else r(new a["default"](i["default"].webRequestFailure, s.format("file uploading failed by data uri with HTTP status: {0}", n)))
                        }, function(e, t, n) {
                    ...
                    return new d.Promise(function(t, r) {
                        e.start(function(e, n) {
                            if (202 === n) {
                                ...
                                t(o)
                            } else r(new a["default"](i["default"].webRequestFailure, s.format("create upload by url job failed with HTTP status: {0}", n)))
                        }, function(e, t, n) {
                        ...
                        return this.buildOauthPromise(e).then(function(e) {
                            ...
                            if ("success" === e.type) {
                                ...
                                var m = {
                                    ...
                                    g = void 0;
                                if (!r.needAPICall() || l && "rps" === r.accessToken.toLowerCase()) g = h.Promise.resolve(m);
                                else {
        ...
        7: [function(e, t, r) {
            ! function(e, t, r, i, n, o, a, s, u, l, d, c) {
                ...
                function m(e, t) {
                    ...
                    } else o.throwError(new l["default"](a["default"].badResponse, "missing state parameter from Oauth redirect")).exposeToPublic()
                }
                ...
                function g(e) {
                    ...
                    if (e.switchAccount) t = c.appendQueryString(t, "prompt", "select_account");
                    else if (e.loginHint) {
                ...
                function w(e, t) {
                    ...
                    return new d.Promise(function(i, o) {
                        var s = n.onMessage(function(e) {
                            if (e.data && typeof e.data.indexOf === 'function' && 0 === e.data.indexOf(R)) {
                                ...
                                } else o(new l["default"](a["default"].popupOpen, "Another popup is already opened."))
                            }
                        });
        ...
        9: [function(e, t, r) {
            ! function(e, t, r, i, n, o, a, s, u, l, d, c) {
                ...
                var g = function() {
                    function e(e, t) {
                        if (e === r["default"].graph_odc || e === r["default"].msa) this.url = l.appendQueryStrings(f, {
                            v: "2"
                        });
                    ...
                    e.prototype.invokePickerUX = function(e, t) {
                        var r = this,
                            ...
                            a = new d.Promise(function(a, u) {
                                        ...
                                        if (s.origin === u[0] + "//" + u[2]) {
                                            ...
                                            if (0 === c.indexOf(h) && s.source === l.getReceiver()) {
                                                var p = JSON.parse(c.substring(h.length)),
                                                    ...
                                                    y = p.type;
                                                if (f === e.id)
                                                    if (y === m) l.send(v + JSON.stringify({
                                                        pickerId: f,
                                                        conversationId: g,
                                                        type: "activate"
                                                    }), s.origin);
                                ...
                                if (!e.parentDiv) return t.openPopup(f).then(function() {
                                    a({
                                        type: "cancel"
                                    })
                                });
            ...
            ! function(e, t, r, i, n, o, a, s, u, l, d, c, p, f, h) {
                ...
                var v = function(e) {
                    ...
                    t.prototype._setFileInfo = function(e) {
                        ...
                        } else o.throwError(new l["default"](a["default"].optionsError, "please specified one type of resource to save"))
                    };
                    return t
                }(s["default"]);
                Object.defineProperty(t, "__esModule", {
        ...
        28: [function(e, t, r) {
            ! function(e, t, r, i) {
                ...
                function n(e) {
                    if (typeof e !== r["default"].TYPE_OBJECT || !e) return null;
                    var t = {};
            ...
            ! function(e, t, r, i, n, o, a, s, u) {
                ...
                function l(e, t, r, l, d) {
                    ...
                    if (void 0 === e) {
                        ...
                        } else i.throwError(new s["default"](n["default"].typeError, "object was missing and not optional"));
                        return null
                    }
                    var p = typeof e;
                    if (p !== t) {
        ...
        32: [function(e, t, r) {
            ! function(e, t, r, i, n, o, a) {
                ...
                function y() {
                    for (var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", t = "", i = 0; i < r["default"].NONCE_LENGTH; i++) t += e.charAt(Math.floor(Math.random() * e.length));
                    return t
                }
                ...
                function E(e, t) {
                    ...
                    for (var r = 0, s = t; r < s.length; r++) {
                        var u = s[r];
                        if (0 === e.toUpperCase().indexOf(u)) return
                    }
                ...
                function _(e) {
                    ...
                    } else i.throwError(new o["default"](n["default"].optionsError, "redirect uri is not an absolute url")).exposeToPublic()
                }
                    ...
                    h = function() {
                        ...
                        e.prototype.start = function(t, r) {
                            ...
                            try {
                                ...
                                if (typeof this._callFailureCallback === 'function') {
                        ...
                        e.prototype._setHeaders = function() {
                            for (var t in this._headers) this._request.setRequestHeader(t, this._headers[t]);
                            if (this._clientId) {
            ...
            ! function(t, n) {
                ...
                function D(e, t) {
                    ...
                    if (B(t)) {
                        ...
                        if (0 === this.length) P(this.promise, this._result);
                        else {
                            this.length = this.length || 0;
                            this._enumerate();
                            0 === this._remaining && P(this.promise, this._result)
                        }
                    } else k(this.promise, q())
                }
                ...
                D.prototype._eachEntry = function(e, t) {
                    ...
                    if (i === f) {
                        var n = g(e);
                        if (n === p && e._state !== ie) this._settledAt(e._state, t, e._result);
